 ...
 * @version 05/25/2022
 */
public class GUI_FactoryIF implements UI_FactoryIF {

    /**
     * Build a UI for the Main Options that returns an
     * integer representing the option chosen.
     *
     * @return A UI_Interface that allows the user to select the main options
     * for ChessMeister. IT will notify its UIFinishedObserverIF instance with an
     ...
     * @return A UI_Interface that allow a player to log in. It will notify its
     * UIFinishedObserverIF  with a PlayerIF implementation for the player
     * logged in.
     */
    @Override
     ...
     * it will notify its observer UIFinishedObserver with a Boolean to show if
     * a change occurred or not.
     */
    @Override
     ...
     * BlackAndWhite
     * @return A UI_Interface implementation what will notify its observer
     * with a Boolean true if the user selected color and false if BlackAndWhite
     */
    @Override
     ...
     * @return Returns a UI_Interface implementation that represents
     * control that takes input from the player. It will notify its
     * UIFinishedObserverIF with a string when done such as a3, or f2 or q for
     * quit.
     */
    @Override
